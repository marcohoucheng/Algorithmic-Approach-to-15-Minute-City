...
if __name__ == '__main__':
    ...
    for i in range(repeat):
        ...
        for idx, service_type in enumerate(services):
            ...
            FMC_tmp = custom_dijkstra(graph_df, new_node_id, t, idx)
    ...
    if repeat > 1:
        print(f"Average execution time over {repeat - threshold} iterations:", total_duration / (repeat - threshold))
    else:
        print("Execution time:", total_duration)

    print(f'There are {len(FMC_df)} nodes in the 15 MC')