...
\subsection{Graph Representation of the 15-Minute City: A Comparison between Rome, London, and Paris}

% \subsection{Graph Representation of the 15-Minute City: A Comparison between Rome, London, and Paris \texorpdfstring{\cite{barbieri_graph_2023}}{}} \label{barbieri_graph_2023}
...
\subsection{Exploring the 15-minute neighbourhoods}
...
\subsection{The inclusive 15-Minute City: Walkability analysis with sidewalk networks}
...
\subsection{Urban accessibility in a 15-Minute City a measure in the city of Naples, Italy}
...
\subsection{Are Italian cities already 15-minute?}
